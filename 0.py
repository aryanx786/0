...
def logo():
    print("\033[1;31m
    _____   ____  _____  ______ __  __  ____  _   _ 
 |  __ \ / __ \|  __ \|  ____|  \/  |/ __ \| \ | |
 | |  | | |  | | |__) | |__  | \  / | |  | |  \| |
 | |  | | |  | |  _  /|  __| | |\/| | |  | | . ` |
 | |__| | |__| | | \ \| |____| |  | | |__| | |\  |
 |_____/ \____/|_|  \_\______|_|  |_|\____/|_| \_|
                                                  

    
    print("\n                     \033[38;2;124;252;0mCreated By: DORAEMON X ARYAN ")
    print("-----------------------------------------------------------------------")
...
def main():
    ...
    logo()
    print('-------------------------------------------')
    print("\033[1;34m Note >>  R3HM9T CH9M9R KI M44 KI CHUTT")
    print('-------------------------------------------')
    coki = input(' [+] Cookies : ')
    cookies={'cookie': coki}
